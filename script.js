  ...
  .catch(() => {
    renderDatalab({
      ...
      recommendation: {
        ...
        priorityMessage:
          "데이터 파일을 불러오지 못했습니다. GitHub Actions 연동 후 깨끗한나라의 우선 공략 카테고리 분석이 자동 갱신됩니다.",
        regionalMessage:
          "경쟁 브랜드가 강한 카테고리일수록 메시지와 판촉 집중도를 높여 점유율을 전환하는 전략으로 확장할 수 있습니다.",
        promoMessage:
          "대리점과 농협 채널에서 진열, 묶음행사, 시즌 프로모션을 연결해 실제 구매 전환 전략으로 활용하도록 설계했습니다.",
      },
    });
  });
